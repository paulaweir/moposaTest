...
<html lang="en">
	<head>
		...
		<link href="js/jquery.mobile-1.3.1.min.css" rel="stylesheet" type="text/css"/><!---include css-->
		<script type="text/javascript" src="js/jquery-1.10.1.min.js"></script><!--include jquery-->
		<script type="text/javascript" src="js/jquery.mobile-1.3.1.min.js"></script><!--include jquery mobile-->
	</head>
